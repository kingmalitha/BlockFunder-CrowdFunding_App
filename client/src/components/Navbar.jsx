...
const Navbar = () => {
  ...
  return (
    <nav className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      <div className="lg:flex-1 flex flex-row py-2 pl-4 pr-2 h-[52px] max-w-[458px] bg-[#1c1c24] rounded-[20px]">
        <input
          type="text"
          name=""
          id=""
        ...
        <div className="w-[72px] flex justify-center items-center cursor-pointer bg-[#4acd8d] rounded-[20px]">
          <img
            src={search}
            alt="search"
